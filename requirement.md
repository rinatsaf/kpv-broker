...
2) Пользователи (Клиенты системы)
...
3) Пути решения (Архитектура)

    Реализовать сетевой протокол (поверх gRPC) (свой упрощенный TCP или поверх HTTP/WebSocket).
...
4) Пользовательские требования (Что умеет делать клиент через API)
...
5) Функц. требования (Внутренняя логика системы)
...
6) Не функц. требования (NFR — Производительность и надежность)
...
7) Не цели (Out of Scope — Что мы НЕ делаем)
